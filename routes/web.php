...
Route::namespace('Api')->prefix('api')->name('api.')->group(function () {
    ...
    Route::resource('/exercises', 'ExercisesController', ['except' => ['show', 'store']]);
    Route::resource('/reglist', 'ReglistController', ['except' => ['show', 'store']]);
    
    Route::get('/partner', 'PartnerController@test')->name('partner.test');

    Route::get('/users/test', 'UserController@test')->name('users.test');
